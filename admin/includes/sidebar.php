<aside id="slide-out" class="side-nav white fixed">
    <div class="side-nav-wrapper">
        ...
        <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
            ...
            <li
                class="no-padding <?= in_array($page, ['adddepartment.php', 'managedepartments.php']) ? 'active' : '' ?>">
                ...
                <div class="collapsible-body">
                    <ul>
                        <li class=" <?= $page == 'adddepartment.php' ? 'blue-grey-text text-darken-2' : '' ?>"><a
                                href="adddepartment.php">Add Department</a></li>
                        <li class=" <?= $page == 'managedepartments.php' ? 'blue-grey-text text-darken-2' : '' ?>"><a
                                href="managedepartments.php">Manage Department</a></li>
                    </ul>
                </div>
            </li>
            <li class="no-padding <?= in_array($page, ['addleavetype.php', 'manageleavetype.php']) ? 'active' : '' ?>">
                ...
                <div class="collapsible-body">
                    <ul>
                        <li class=" <?= $page == 'addleavetype.php' ? 'blue-grey-text text-darken-2' : '' ?>"><a
                                href="addleavetype.php">Add Leave Type</a></li>
                        <li class=" <?= $page == 'manageleavetype.php' ? 'blue-grey-text text-darken-2' : '' ?>"><a
                                href="manageleavetype.php">Manage Leave Type</a></li>
                    </ul>
                </div>
            </li>
            <li class="no-padding">
