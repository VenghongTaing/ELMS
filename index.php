                    ...
                    <div class="col-md-6 d-flex justify-content-center align-items-center">
                        <div class="card white darken-1">
                            ...
                            <div class="card-content ">
                                <span class="card-title blue-gray-text text-darken-2" style="font-size:20px;">Employee
                                    Login</span>
                                <?php if ($msg) { ?>
                                    ...
                                    <form class="col col-md-12 " name="signin" method="post">
                                        ...
                                        <div class="col col-md-12 center m-t-sm">
                                            ...
                                            <input type="submit" name="signin" value="Login"
                                                class=" waves-effect waves-light btn blue-gray darken-4">
                                            <a class="waves-effect waves-grey" href="forgot-password.php"
                                                style="margin-bottom: 10px; margin-left: 10px;">Emp Password
                                                Recovery?</a>
                                        </div>
                                    </form>
                                </div>
